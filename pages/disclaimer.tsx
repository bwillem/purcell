                ...
                <Container className='space-y-8 py-24'>
                    ...
                    <div className='space-y-4'>
                        ...
                        <p className='text-white space-y-4'>
                            ...
                            current or future performance of the property. You and your advisors should conduct a
                            careful, independent investigation of the property to determine to your satisfaction the
                    ...
                    <div className='text-white space-y-4'>
                        ...
                        <p className='text-white'>
                            You will be deemed to have accepted these Terms of Use if you continue to use the
                            site, even after any amendments are posted on the site. We reserve the right to refuse
                            to provide our products and services to anyone at any time.
                            This agreement contains warranty and liability disclaimers. By using this site, you
                            accept and agree to the terms and conditions of this agreement without any
                            reservations, modifications, additions, or deletions. If you do not agree to the Terms of
                            Use contained in this agreement, you are not authorized to use the site. You may be
                            denied access to the site, with or without prior notice to you if you do not comply with
                            any provision of this agreement.
                        </p>
                        <Bold>Authorized Users</Bold>
                        <p className='text-white'>
